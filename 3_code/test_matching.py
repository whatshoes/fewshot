...
class SiameseNetworkTestDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img0_tuple = ['./supportset2/supportset/s11/img1.jpg']
        img1_tuple = ['./supportset2/supportset/s{}/img{}.jpg'.format(SiameseNetworkTestDataset.i, SiameseNetworkTestDataset.j)]
...
folder_dataset_test = dset.ImageFolder(root="./supportset2")
