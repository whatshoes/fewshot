...
class SiameseNetworkTestDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img0_tuple = [
            './t_sne/image1/s{}/img{}.jpg'.format(SiameseNetworkTestDataset.k, SiameseNetworkTestDataset.i),
            SiameseNetworkTestDataset.k - 1]
        img1_tuple = [
            './t_sne/image1/s{}/img{}.jpg'.format(SiameseNetworkTestDataset.k, SiameseNetworkTestDataset.j),
            SiameseNetworkTestDataset.k - 1]
...
net.load_state_dict(torch.load('./t_sne/model/case2/model10.pth', map_location=device))
